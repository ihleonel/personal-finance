...
@dataclass
class UpdateTransferDetectionRuleUseCase:
    ...
    def execute(
        ...
        owner_id: int,
        rule_id: int,
        data: UpdateTransferDetectionRuleInput,
        ...
        if not rule.is_active:
            result.add_error(
                "non_field_errors",
                "transfer_detection.rule.inactive",
        ...
        has_any_field = any(
            ...
            for f in ("pattern", "match_type", "priority")
        )
        if not has_any_field:
            result.add_error(
                "non_field_errors",
                "transfer_detection.rule.empty_payload",
